...
python_days = ['Thirty', 'Days', 'Of', 'Python']

coding_all = ['Coding', 'For', 'All']
company = ' Coding For All Coding'
print(company)
print(len(company))
print(company.upper())
print(company.lower())
...
print(company[0:6])
print(company.find('ng'))
company = company.replace('Coding', 'Python').replace('All', 'Everyone')
print(company)
...
if company.find('Coding') == 0:
    print('\'Coding\' is the first word in the string')
elif company.rfind('Coding') == len(company) - 6:
    print('\'Coding\' is at the end of the string')
...
print(new_coding.strip()) #strip only removes whitespace from the beginning and end of the string, not in between words

what =  ['Django', 'Flask', 'Bottle', 'Pyramid', 'Falcon']
print(' '.join(what))
